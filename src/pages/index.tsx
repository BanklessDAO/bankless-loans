  ...
  return (
    ...
    >
      ...
      <Stack direction={["column", "row"]} my="3" spacing="3">
        ...
        <StyledBox p="5" rounded="md" w={["100%", "50%"]} color='#6257DE' bg='white'>
          ...
          <Stack textAlign="center" mt="3" p="5"
        ...
        <StyledBox
          ...
          <Heading textAlign="left" size="md"
            ...
            fontSize='30px'
            lineHeight='32px'
            letterSpacing='0.5'>Earn fees by stacking LQTY</Heading>
    ...
    {/* How it works */}
      <Stack direction="column" p="5" color='#6257DE' bg='white' borderRadius='18px'>
        ...
        <Box  display="flex" justifyItems="center" flexDirection="column">
          <Stack justifyContent="center" direction={["column-reverse", "row"]}
            my="3"
            spacing="3">
            <Box><img src="#"></img></Box>
            <Box>Text</Box>
