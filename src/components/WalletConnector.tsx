        ...
        <>
                ...
                <Modal>
                    ...
                    >
                        <Box sx={{ textAlign: 'center' }}>
                            You might need to install MetaMask or use a
                            different browser.
                        </Box>
                        <Link
                            sx={{ lineHeight: 3 }}
                        ...
                        >
                            Learn more{' '}
                            <Icon size='xs' name='external-link-alt' />
                        </Link>
                    </RetryDialog>
                </Modal>
            )}
                    ...
                    >
                        <Text sx={{ textAlign: 'center' }}>
                            ...
                            {isMetaMask ? (
                                <>
                                    {' '}
                                    If you can&apos;t see a request, open your
                                    MetaMask extension via your browser.
                                </>
                            ) : (
                                <>
                                    {' '}
                                    If you can&apos;t see a request, you might
            ...
            {connectionState.type === 'rejectedByUser' && (
                <Modal>
                    ...
                    >
                        <Text>
                            To use Liquity, you need to connect your Ethereum
                            account.
                        </Text>
                    </RetryDialog>
                </Modal>
            ...
            {connectionState.type === 'alreadyPending' && (
                <Modal>
                    ...
                    >
                        <Text>
                            Please check your wallet and accept the connection
